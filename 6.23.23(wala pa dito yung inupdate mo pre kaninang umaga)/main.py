...
def employeeWindow():
    ...
    def run_another_file():
        command = ['python', 'C:/Users/Booster/Documents/python/sample.py']
    ...
    leaveForm = tkinter.Button(empwind, text = 'Leave Form', command=button_callback).grid(row=6, column=1, padx=10, pady=0)
...
def adminui():
    ...
    adwin_label2=tkinter.Label(adwin, text="Enter Employee", width=30, height=2)
    adwin_label2.grid(row = 1, column = 1,  padx=10, pady=10)

    adwin_entry = tkinter.Entry(adwin)
    adwin_entry.grid(row = 2, column = 1,  padx=10, pady=10)

    adwin_btn1=tkinter.Button(adwin, text="Time in Records", command=showtimein)
    adwin_btn1.grid(row = 3, column = 0,  padx=10, pady=10)
    
    adwin_btn2=tkinter.Button(adwin, text="Time out Records", command=showtimeout)
    adwin_btn2.grid(row = 3, column = 1,  padx=10, pady=10)

    adwin_btn3=tkinter.Button(adwin, text="Leave Records", command=showleave)
    adwin_btn3.grid(row = 3, column = 2, padx=10, pady=10)

    create_emp = tkinter.Button(adwin, text="Insert new employee", command=create_employee)
    create_emp.grid(row = 4, column = 0, padx=10, pady=10)

    pips_emp = tkinter.Button(adwin, text="Employees", command=showemployees)
    pips_emp.grid(row = 4, column = 1, padx= 10,pady=10)

    del_emp = tkinter.Button(adwin, text="Remove employee record", command=bura_emp)
    del_emp.grid(row = 4, column = 2, padx=10, pady=10)
    ...
    back_adwin.grid(row = 5, column = 1, padx=10, pady=10)
    ...
    adwin.rowconfigure(4, weight=1)
    adwin.rowconfigure(5, weight=1)
